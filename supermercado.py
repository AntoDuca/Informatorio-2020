...
class supermercado:
    ...
    def cantidadTotalProductos(self, productos):
...
catalogo1.agregarProducto('Villa Vicencio', 'agua',50,True, True )
catalogo1.agregarProducto('Cofler', 'chocolate blanco', 80)
print(catalogo1)
supermercado1.cantidadTotalProductos(catalogo1)
