...
class Libro:
    ...
    def getCalificacion(self, calificaciom):
...
class conjuntoLibros:
    ...
    def MostrarLibrosPorCalificacion(self):
        for self.calificacion in range(0, ):
...
menu()
libro1=Libro("gdgdg", "hdhd", 499, 4)
         

#Espacio de objetos

libro1 = Libro("El Principito", "Saint Extuperri", 200, 9)
conjuntoLibros1 = conjuntoLibros('Mis Libros Fav')
conjuntoLibros1.añadirLibro(libro1)
print(libro1)
print(conjuntoLibros1)